	...
	factory: (require) => {
		...
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			...
			tag.textContent = [
				...
				".oq-ds-cost{font-size:12px;font-weight:700;color:#f0a63c;border:1px solid rgba(240,166,60,.35);background:rgba(240,166,60,.1);padding:1px 8px;border-radius:999px;white-space:nowrap}",
				".oq-ds-balance-sub{font-size:12px;color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums}",
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, {
				children: [
						...
						children: [
							...
							taskCost !== null
								? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, {
									children: [
										(0, react_jsx_runtime.jsx)("span", { className: "oq-ds-big oq-money", children: `¥${fmtCost(taskCost.total)}` }, "big"),
										(0, react_jsx_runtime.jsx)("span", { className: "oq-ds-balance-sub", children: `余额 ${fmtMoney(balance.totalBalance)}` }, "bal"),
										(0, react_jsx_runtime.jsx)("span", {
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							(0, react_jsx_runtime.jsx)("div", { className: "oq-ds-usage-title", children: "花费明细" }, "title"),
							(0, react_jsx_runtime.jsxs)("div", { className: "oq-urow", children: [
								(0, react_jsx_runtime.jsx)("span", { className: "oq-urow-label", children: "今日" }, "l"),
								(0, react_jsx_runtime.jsx)("span", {
									className: todayCost ? "oq-urow-value oq-money" : "oq-urow-value",
									children: todayCost ? `¥${fmtCost(todayCost.total)}` : "—"
								}, "v")]
							}, "today"),
							(0, react_jsx_runtime.jsxs)("div", { className: "oq-urow", children: [
								(0, react_jsx_runtime.jsx)("span", { className: "oq-urow-label", children: "本月" }, "l"),
								(0, react_jsx_runtime.jsx)("span", {
									className: monthCost ? "oq-urow-value oq-money" : "oq-urow-value",
									children: monthCost ? `¥${fmtCost(monthCost.total)}` : "—"
								}, "v")]
							}, "month"),
							(0, react_jsx_runtime.jsxs)("div", { className: "oq-urow", children: [
								(0, react_jsx_runtime.jsx)("span", { className: "oq-urow-label", children: "余额" }, "l"),
								(0, react_jsx_runtime.jsx)("span", {
									className: "oq-urow-value",
									children: fmtMoney(balance.totalBalance)
								}, "v")]
							}, "bal")
						]
					}, "usage")
