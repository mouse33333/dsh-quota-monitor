	...
	factory: (require) => {
		...
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			...
			tag.textContent = [
				...
				/* deepseek: 3-layer visual hierarchy */
				...
				".oq-ds-layer3{display:flex;align-items:center;gap:8px;padding:6px 0;border-top:1px solid var(--dsw-alias-border-l1)}",
		...
		function DeepSeekBody({ state, task, onRetry }) {
			...
			const taskCost = task && task.status === "ok" && task.payload && task.payload.cost ? task.payload.cost : null;
			const todayCost = state.payload.todayCost;
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, {
				children: [
					/* layer 1: 当前任务花费 — 最大最醒目 */
					(0, react_jsx_runtime.jsxs)("div", {
						className: "oq-ds-layer1",
						children: [
							(0, react_jsx_runtime.jsx)("span", { className: "oq-ds-layer-label", children: "当前花费" }, "label"),
							(0, react_jsx_runtime.jsx)("span", {
								className: "oq-ds-layer1-value oq-money",
								children: taskCost !== null ? `¥${fmtCost(taskCost.total)}` : "—"
							}, "value")
						]
					}, "layer1"),
					/* layer 2: 今日花费 — 中等大小 */
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsx)("span", { className: "oq-ds-layer3-value", children: fmtMoney(balance.totalBalance) }, "value"),
							(0, react_jsx_runtime.jsx)("span", {
